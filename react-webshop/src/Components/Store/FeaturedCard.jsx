...
export default function FeaturedCard({brand, model, edition, src, description, price}) {
    ...
    return (
        <div className="card border-primary mb-3 me-3 col-3">
                    ...
                    <div className="card-body">
                        ...
                        <h6 className="card-subtitle text-muted">{edition}</h6>
                    </div>
                    ...
                    <ul className="list-group list-group-flush">
                        <li className="list-group-item text-center">{price}</li>
